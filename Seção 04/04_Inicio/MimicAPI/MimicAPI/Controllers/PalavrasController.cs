...
namespace MimicAPI.Controllers
{
    ...
    public class PalavrasController : ControllerBase
    {
        ...
        //APP - Primeiro método reponsável pela carga de palavras
        ...
        // --/api/palavras/(POST: id, nome, ativo, pontuacao, criação)
        [Route("")]
        [HttpPost]
        ...
        // --/api/palavras/1 (PUT: id, nome, ativo, pontuacao, criação)
